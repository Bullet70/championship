export class InformationteamModel {
	id: number;
	name: string;
	team:number;
	league: number;
...
export const INFORMATIONTEAMS: InformationteamModel[] = [
	...
	{ id: 6, name:"Società", team: 2, league: 1 },
	{ id: 7, name:"Rosa", team: 3, league: 1 },
	{ id: 8, name:"Squadra", team: 3, league: 1 },
	{ id: 9, name:"Società", team: 3, league: 1 },
